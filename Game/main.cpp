...
int main(int argc,char *argv[])
{
	...
	const char* sceneFileName = "scene5.txt";
	...
	*/
	...
	int writeStatus = stbi_write_png("raytracedimage2.png", DISPLAY_WIDTH, DISPLAY_HEIGHT, 4, raytracer.getTextureData(), DISPLAY_WIDTH * 4);
	std::cout << "wrtie status=" << writeStatus << std::endl;
	//scn->AddTexture(256,256, raytracer.getTextureData());
		scn->AddTexture(std::string("raytracedimage2.png"), 1);
